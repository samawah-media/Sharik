...
`X009_A_CI_CORRECTION_PENDING`. Product/database/hosted verification remains green. Exact-head CI run `29835323916` passed through all persistent scenarios, then exposed S015-P1-092 in the final build: a partially generated ignored `.next-persistent` type artifact survived dev-server termination. A guarded pre-build cleanup is locally green and awaits exact-head CI.
...
- Remaining gate: exact-head CI verification of S015-P1-092. H008-H010/X007/T032/X008-H remain unchanged.
