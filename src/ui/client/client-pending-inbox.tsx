...
export function ClientPendingInbox({
  ...
  const intro = canApprove
    ? "راجع كل نسخة معتمدة من فريق سماوة، ثم اعتمدها أو أرسل ملاحظات التعديل على النسخة نفسها."
  ...
  const emptyTitle = canApprove
    ? "لا توجد أعمال بانتظار اعتمادك حالياً."
    : "لا توجد أعمال قيد المراجعة الآن";
  const emptyDescription = canApprove
    ? "تم استلام قراراتك بنجاح."
